package tv.danmaku.cap.media.exo;
...
import tv.danmaku.cap.media.exo.demo.EventLogger;
import tv.danmaku.cap.media.exo.demo.player.DemoPlayer;
import tv.danmaku.cap.media.exo.demo.player.DemoPlayer.RendererBuilder;
import tv.danmaku.cap.media.exo.demo.player.ExtractorRendererBuilder;
import tv.danmaku.cap.media.player.AbstractMediaPlayer;
import tv.danmaku.cap.media.player.IMediaPlayer;
import tv.danmaku.cap.media.player.MediaInfo;
import tv.danmaku.cap.media.player.misc.CapTrackInfo;

public class CapExoMediaPlayer extends AbstractMediaPlayer {
    ...
    public CapExoMediaPlayer(Context context) {
    ...
    private String getUserAgent() {
        return Util.getUserAgent(mAppContext, "CapExoMediaPlayer");
    }
