...
public class CapMediaMeta {
    // media meta
    public static final String CAPM_KEY_FORMAT = "format";
    public static final String CAPM_KEY_DURATION_US = "duration_us";
    public static final String CAPM_KEY_START_US = "start_us";
    public static final String CAPM_KEY_BITRATE = "bitrate";
    public static final String CAPM_KEY_VIDEO_STREAM = "video";
    public static final String CAPM_KEY_AUDIO_STREAM = "audio";

    // stream meta
    public static final String CAPM_KEY_TYPE = "type";
    public static final String CAPM_VAL_TYPE__VIDEO = "video";
    public static final String CAPM_VAL_TYPE__AUDIO = "audio";
    public static final String CAPM_VAL_TYPE__UNKNOWN = "unknown";

    public static final String CAPM_KEY_CODEC_NAME = "codec_name";
    public static final String CAPM_KEY_CODEC_PROFILE = "codec_profile";
    public static final String CAPM_KEY_CODEC_LEVEL = "codec_level";
    public static final String CAPM_KEY_CODEC_LONG_NAME = "codec_long_name";
    public static final String CAPM_KEY_CODEC_PIXEL_FORMAT = "codec_pixel_format";

    // stream: video
    public static final String CAPM_KEY_WIDTH = "width";
    public static final String CAPM_KEY_HEIGHT = "height";
    public static final String CAPM_KEY_FPS_NUM = "fps_num";
    public static final String CAPM_KEY_FPS_DEN = "fps_den";
    public static final String CAPM_KEY_TBR_NUM = "tbr_num";
    public static final String CAPM_KEY_TBR_DEN = "tbr_den";
    public static final String CAPM_KEY_SAR_NUM = "sar_num";
    public static final String CAPM_KEY_SAR_DEN = "sar_den";
    // stream: audio
    public static final String CAPM_KEY_SAMPLE_RATE = "sample_rate";
    public static final String CAPM_KEY_CHANNEL_LAYOUT = "channel_layout";

    public static final String CAPM_KEY_STREAMS = "streams";
    ...
    public ArrayList<CapStreamMeta> mStreams = new ArrayList<CapStreamMeta>();
    public CapStreamMeta mVideoStream;
    public CapStreamMeta mAudioStream;
    ...
    public static CapMediaMeta parse(Bundle mediaMeta) {
        if (mediaMeta == null)
            return null;

        CapMediaMeta meta = new CapMediaMeta();
        meta.mMediaMeta = mediaMeta;

        meta.mFormat = meta.getString(CAPM_KEY_FORMAT);
        meta.mDurationUS = meta.getLong(CAPM_KEY_DURATION_US);
        meta.mStartUS = meta.getLong(CAPM_KEY_START_US);
        meta.mBitrate = meta.getLong(CAPM_KEY_BITRATE);

        int videoStreamIndex = meta.getInt(CAPM_KEY_VIDEO_STREAM, -1);
        int audioStreamIndex = meta.getInt(CAPM_KEY_AUDIO_STREAM, -1);

        ArrayList<Bundle> streams = meta
                .getParcelableArrayList(CAPM_KEY_STREAMS);
        if (streams == null)
            return meta;
        ...
        for (Bundle streamBundle : streams) {
            ...
            CapStreamMeta streamMeta = new CapStreamMeta(index);
            streamMeta.mMeta = streamBundle;
            streamMeta.mType = streamMeta.getString(CAPM_KEY_TYPE);
            if (TextUtils.isEmpty(streamMeta.mType))
                continue;

            streamMeta.mCodecName = streamMeta.getString(CAPM_KEY_CODEC_NAME);
            streamMeta.mCodecProfile = streamMeta
                    .getString(CAPM_KEY_CODEC_PROFILE);
            streamMeta.mCodecLongName = streamMeta
                    .getString(CAPM_KEY_CODEC_LONG_NAME);
            streamMeta.mBitrate = streamMeta.getInt(CAPM_KEY_BITRATE);

            if (streamMeta.mType.equalsIgnoreCase(CAPM_VAL_TYPE__VIDEO)) {
                streamMeta.mWidth = streamMeta.getInt(CAPM_KEY_WIDTH);
                streamMeta.mHeight = streamMeta.getInt(CAPM_KEY_HEIGHT);
                streamMeta.mFpsNum = streamMeta.getInt(CAPM_KEY_FPS_NUM);
                streamMeta.mFpsDen = streamMeta.getInt(CAPM_KEY_FPS_DEN);
                streamMeta.mTbrNum = streamMeta.getInt(CAPM_KEY_TBR_NUM);
                streamMeta.mTbrDen = streamMeta.getInt(CAPM_KEY_TBR_DEN);
                streamMeta.mSarNum = streamMeta.getInt(CAPM_KEY_SAR_NUM);
                streamMeta.mSarDen = streamMeta.getInt(CAPM_KEY_SAR_DEN);

                if (videoStreamIndex == index) {
                    meta.mVideoStream = streamMeta;
                }
            } else if (streamMeta.mType.equalsIgnoreCase(CAPM_VAL_TYPE__AUDIO)) {
                streamMeta.mSampleRate = streamMeta
                        .getInt(CAPM_KEY_SAMPLE_RATE);
                streamMeta.mChannelLayout = streamMeta
                        .getLong(CAPM_KEY_CHANNEL_LAYOUT);
    ...
    public static class CapStreamMeta {
        public Bundle mMeta;
        ...
        public CapStreamMeta(int index) {
            mIndex = index;
        }
