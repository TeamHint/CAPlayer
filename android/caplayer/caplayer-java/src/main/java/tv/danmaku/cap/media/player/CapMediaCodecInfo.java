...
public class CapMediaCodecInfo {
    private final static String TAG = "CapMediaCodecInfo";
    ...
    public static CapMediaCodecInfo setupCandidate(MediaCodecInfo codecInfo,
            String mimeType) {
        if (codecInfo == null
        ...
        CapMediaCodecInfo candidate = new CapMediaCodecInfo();
