        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_HUD: {
                    ...
                    CapMediaPlayer mp = null;
                    if (mMediaPlayer == null)
                        break;
                    if (mMediaPlayer instanceof CapMediaPlayer) {
                        mp = (CapMediaPlayer) mMediaPlayer;
                        ...
                        if (internal != null && internal instanceof CapMediaPlayer)
                            mp = (CapMediaPlayer) internal;
                    }
                    if (mp == null)
                        break;
