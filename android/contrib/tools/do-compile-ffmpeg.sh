...
ln -s $FF_PREFIX/libcapffmpeg.so $FF_PREFIX/shared/lib/libcapffmpeg.so
...
for f in $FF_PREFIX/lib/pkgconfig/*.pc; do
    ...
    mysedi $f 's/-lavcodec/-lcapffmpeg/g'
    mysedi $f 's/-lavfilter/-lcapffmpeg/g'
    mysedi $f 's/-lavformat/-lcapffmpeg/g'
    mysedi $f 's/-lavutil/-lcapffmpeg/g'
    mysedi $f 's/-lswresample/-lcapffmpeg/g'
    mysedi $f 's/-lswscale/-lcapffmpeg/g'
done
