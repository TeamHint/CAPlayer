/*
 * caplayer_android_def.h

 */

#ifndef CAPLAYER_ANDROID__CAPLAYER_ANDROID_DEF_H
#define CAPLAYER_ANDROID__CAPLAYER_ANDROID_DEF_H
...
typedef struct capmp_mediacodecinfo_context
{
    char mime_type[128];    //< in
    int  profile;           //< in
    int  level;             //< in
    char codec_name[128];   //< out
} capmp_mediacodecinfo_context;
