/*****************************************************************************
 * capsdl_android_jni.h
 *****************************************************************************

 */

#ifndef CAPSDL_ANDROID__CAPSDL_ANDROID_JNI_H
#define CAPSDL_ANDROID__CAPSDL_ANDROID_JNI_H

#include <jni.h>
#include "capsdl/android/jjk/internal/jjk_internal.h"

#define CAP_API_1_BASE                      1   // 1.0
#define CAP_API_2_BASE_1_1                  2   // 1.1
#define CAP_API_3_CUPCAKE                   3   // 1.5
#define CAP_API_4_DONUT                     4   // 1.6
#define CAP_API_5_ECLAIR                    5   // 2.0
#define CAP_API_6_ECLAIR_0_1                6   // 2.0.1
#define CAP_API_7_ECLAIR_MR1                7   // 2.1
#define CAP_API_8_FROYO                     8   // 2.2
#define CAP_API_9_GINGERBREAD               9   // 2.3
#define CAP_API_10_GINGERBREAD_MR1          10  // 2.3.3
#define CAP_API_11_HONEYCOMB                11  // 3.0
#define CAP_API_12_HONEYCOMB_MR1            12  // 3.1
#define CAP_API_13_HONEYCOMB_MR2            13  // 3.2
#define CAP_API_14_ICE_CREAM_SANDWICH       14  // 4.0
#define CAP_API_15_ICE_CREAM_SANDWICH_MR1   15  // 4.0.3
#define CAP_API_16_JELLY_BEAN               16  // 4.1
#define CAP_API_17_JELLY_BEAN_MR1           17  // 4.2
#define CAP_API_18_JELLY_BEAN_MR2           18  // 4.3
#define CAP_API_19_KITKAT                   19  // 4.4
#define CAP_API_20_KITKAT_WATCH             20  // 4.4W
#define CAP_API_21_LOLLIPOP                 21  // 5.0
#define CAP_API_22_LOLLIPOP_MR1             22  // 5.1
#define CAP_API_23_M                        23  // 6.0
...
#define CAP_FIND_JAVA_CLASS(env__, var__, classsign__) \
    do { \
